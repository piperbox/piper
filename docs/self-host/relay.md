...
[end-to-end runbook](../ops/e2e-runbook.md#part-b--relay) for verification,
...
The piperbox-hosted relay's own layout — k3s, Flux, the Hetzner host — is documented for its operators in [ops/hosted-relay.md](../ops/hosted-relay.md).
